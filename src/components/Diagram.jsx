      ...
      <button onClick={handleEditNodeName} className="bg-green-500 text-white p-0 mt-0 w-full">Guardar Nombre</button>
        ...
        <div>
          ...
          <button
            ...
            className="bg-teal-500 hover:bg-teal-600 text-white px-4 py-2 mt-0"
          >
            Asociación
          </button>
          <button
            onClick={handleEnableAssociationDirect}
            className="bg-teal-500 hover:bg-teal-600 text-white px-1 py-2 mt-1"
          >
            Asociación Directa
          </button>
          <button
            onClick={handleEnableComposition}
            className="bg-teal-500 hover:bg-teal-600 text-white px-4 py-2 mt-2"
          >
            Composición
          </button>
          <button
          ...
          <button
            ...
            className="bg-teal-500 hover:bg-teal-600 text-white px-2 py-2 mt-2"
          >
            Asosiacion Class
          </button>
        </div>
