      ...
      <div className="relative mt-12 w-full max-w-lg sm:mt-10">
        ...
        <div className="mx-5 border dark:border-b-white/50 dark:border-t-white/50 border-b-white/20 sm:border-t-white/20 shadow-lg rounded-lg border-white/20 border-l-white/20 border-r-white/20 sm:shadow-sm lg:rounded-xl">
          <div className="flex flex-col p-6">
            ...
            <p className="mt-1.5 text-sm font-medium text-white/50">Regístrate para colaborar en tiempo real 👌🏻.</p>
          </div>
          ...
          <div className="p-6 pt-0">
            <form onSubmit={handleSubmit}>
              ...
              <div className="mt-4 flex items-center justify-end gap-x-2">
                <Link to="/login" className="inline-flex items-center justify-center rounded-md text-sm font-medium bg-white text-black px-4 py-2">
                  Volver al login
                </Link>
                <button
                  type="submit"
